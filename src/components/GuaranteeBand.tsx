	...
	return (
		<div className="glow">
			<div className="panel ticked relative overflow-hidden rounded-[22px] p-8 sm:p-10">
				<div className="pointer-events-none absolute -right-24 -top-24 h-64 w-64 rounded-full bg-[radial-gradient(circle,var(--warm-tint),transparent_70%)] opacity-70 blur-3xl" />
				<div className="grid items-center gap-7 sm:grid-cols-[auto_1fr]">
					<div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl border border-border bg-surface-2 text-violet">
						<ShieldCheck className="h-8 w-8" />
					</div>
					<div>
						<p className="kicker mb-3">The guarantee</p>
